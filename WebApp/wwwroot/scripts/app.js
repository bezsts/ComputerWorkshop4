...
class MovieService {
    ...
    async createMovie(movieData) {
        try {
            ...
            this.renderMovies([movie], false, true);
        } catch (error) {
            console.error(error);
        }
    }
    ...
    createMovieElement(movie, isWatched = false, isJustCreated = false) {
        ...
        if (!isWatched && !isJustCreated) {
            ...
            li.append(titleDiv, metadataDiv);
    ...
    renderMovies(movies, isWatched = false, isJustCreated = false) {
        this.listElement.innerHTML = '';
        movies.forEach((movie) => {
            this.listElement.appendChild(this.createMovieElement(movie, isWatched, isJustCreated));
        });
    }
